...
export function PremiumDesignsSection() {
  return (
    <section className="w-full max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between py-16 lg:py-24 px-4 md:px-8 gap-12 lg:gap-20 relative z-20">
